...
function User() {
  ...
  const { getGitUser, gitUser, loading } = useContext(GithubContext)
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaUsers className="text-3xl text-5xl"/>
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaUserFriends className="text-3xl text-5xl"/>
            </div>
            <div className="stat-title">
              Following
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaCodepen className="text-3xl text-5xl"/>
            </div>
            <div className="stat-title">
              Public Repos
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaStore className="text-3xl text-5xl"/>
            </div>
            <div className="stat-title">
              Public Gists
            </div>
